...
// ---------------------------------------------------------------------------
// Seed subscriptions
// Context window is PER PROVIDER — the same model may have different context
// windows depending on the provider (e.g. Gemini 3.1 Pro: 1M at Google API,
// ~200K at Copilot). Each subscription records the provider-specific limit.
// ---------------------------------------------------------------------------

const SEED_SUBSCRIPTIONS: PickerSubscription[] = [
  // ─── Copilot (free, rate-limited, ~200K context cap for all models) ───
  {
    id: "copilot-gpt-5.4",
    provider: "copilot",
    model: "gpt-5.4",
  ...
  // ─── Google API (paid, 1M context) ───
  {
    id: "google-api-gemini-3.1-pro",
    provider: "google",
    model: "gemini-3.1-pro",
