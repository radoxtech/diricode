...
| --- | ------------------------- | --------------------------- | ----------- | -------------------------------------------------------------------- |
| 0   | **Diricontext**           | `packages/diricontext/`     | In Progress | Graph-based directed context — project knowledge across 3 namespaces |
...
### Module 0: Diricontext (`packages/diricontext/`)
...
- **packages/diricontext/**: Diricontext implementation.
