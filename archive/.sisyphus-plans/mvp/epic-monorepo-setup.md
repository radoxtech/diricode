...
- Source: `.sisyphus/plans/overview.md` (architecture + package index), `spec-mvp-diricode.md` (stack + monorepo)
...
- Source: `.sisyphus/plans/overview.md`, `.sisyphus/plans/mvp/index.md`, `spec-mvp-diricode.md`
...
- Source: `.sisyphus/plans/cross-cutting.md` (TS conventions), `spec-mvp-diricode.md` (ESM + Bun)
...
- Source: `.sisyphus/plans/cross-cutting.md`, `spec-mvp-diricode.md` (Bun runtime; Linux/macOS support)
...
- Source: `.sisyphus/plans/mvp/index.md` (POC gating), `spec-mvp-diricode.md` (platform constraints)
